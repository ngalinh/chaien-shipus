...
const SECTIONS = [
  ...
  },
  {
    ...
    features: [
      ...
      'Kiểm tra danh sách KH trước khi tạo để tránh trùng mã KH',
    ],
    steps: [
      { img: imgCustomers, label: 'Tổng quan', caption: 'Danh sách khách hàng với trạng thái hoạt động, nhóm cước và lịch sử' },
      { img: imgTaoKH, label: 'Tạo mã KH mới', caption: 'Chọn kho → nhập mã KH (US: SU + tên / UK: Duonglinh + tên) → chọn nhóm KH → upload CCCD' },
