...
/**
 * Lịch sử đăng nhập / kết nối của từng profile Zalo. Ghi nối tiếp vào 1 file JSON (mảng),
 * giữ tối đa MAX_ENTRIES bản ghi gần nhất.
 *
 * type gợi ý: 'login' | 'session_ok' | 'session_expired' | 'delete'
 */
